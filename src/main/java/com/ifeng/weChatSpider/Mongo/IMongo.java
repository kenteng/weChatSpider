...
public interface IMongo {
	 ...
	 * @throws Exception
	 */
    <T extends EntyCodec> T selectOne(MongoSelect select, Class<T> classType) throws Exception;
	 ...
	 * @throws Exception
	 */
    <T extends EntyCodec> List<T> selectAll(MongoSelect select, Class<T> classType) throws Exception;
	 ...
	 * @throws Exception
	 */
    <T extends EntyCodec> List<T> selectList(MongoSelect select, Class<T> classType) throws Exception;


    <T extends EntyCodec> List<T> selectListByAggregate(MongoSelect select, Class<T> classType) throws Exception;
	 ...
	 * @throws Exception
	 */
    <T  extends EntyCodec> void insert(T en)  throws Exception;
	 ...
	 * @throws Exception
	 */
    <T extends EntyCodec> void insert(List<T> list)  throws Exception;
	...
	<T extends EntyCodec> void insert(T en, Date expire) throws Exception;

	<T extends EntyCodec> void insert(List<T> list, Date expire) throws Exception;
