...
import com.ifeng.weChatSpider.Util.LogUtil;
...
public class MongoCli implements IMongo {
    ...
    public MongoCli(List<ServerAddress> serverAddresses) {
...
//				.iterator();
    ...
    @Override
    public <T extends EntyCodec> List<T> selectListByAggregate(MongoSelect select, Class<T> classType) throws Exception {
        ...
        if (select.getGroupBy() != null && select.getGroupBy().size() > 0) {
            ...
            for (SelectField item : select.getFields()) {
                ...
                if (field.contains("sum(")) {
                    document.append(fn, new Document("$sum", "$" + field.replace("sum(", "").replace(")", "")));
                    ;//字段名
                }
    ...
    @Override
    public <T extends EntyCodec> void insert(T en) throws Exception {
        if (collection == null) {
            throw new NullPointerException();
        }
    ...
    @Override
    public <T extends EntyCodec> void insert(List<T> list) throws Exception {
        if (collection == null) {
            throw new NullPointerException();
        }
    ...
    @Override
    public <T extends EntyCodec> void insert(T en, Date expire) throws Exception {
        if (collection == null) {
            throw new NullPointerException();
        }
    ...
    @Override
    public <T extends EntyCodec> void insert(List<T> list, Date expire) throws Exception {
        if (collection == null) {
            throw new NullPointerException();
        }
        List<Document> documents = new ArrayList<Document>();
